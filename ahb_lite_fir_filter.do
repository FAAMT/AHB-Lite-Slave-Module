...
add wave -noupdate -expand -group {CLK & NRST} -color yellow /tb_ahb_lite_fir_filter/tb_n_rst
add wave -noupdate -expand -group {CLK & NRST} -color yellow /tb_ahb_lite_fir_filter/tb_clk
...
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} -color Cyan /tb_ahb_lite_fir_filter/DUT/AHB/new_coefficient_set
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} -color Cyan -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/fir_coefficient
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} -color Cyan /tb_ahb_lite_fir_filter/DUT/load_coeff
...
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} -color Yellow /tb_ahb_lite_fir_filter/DUT/FF/data_ready
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} -color Cyan /tb_ahb_lite_fir_filter/DUT/CFL/modwait
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} /tb_ahb_lite_fir_filter/DUT/err
add wave -noupdate -expand -group {COEFF LOADER SIGNALS} -color Cyan /tb_ahb_lite_fir_filter/DUT/CFL/coefficient_num
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/src1
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/src2
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/dest
add wave -noupdate -expand -group {FIR FILTER SIGNALS} /tb_ahb_lite_fir_filter/DUT/FF/D1/alu_result
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/D1/dest_data
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow /tb_ahb_lite_fir_filter/DUT/FF/B1/curstate
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow /tb_ahb_lite_fir_filter/DUT/FF/B1/nexstate
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow /tb_ahb_lite_fir_filter/DUT/FF/B1/lc
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow /tb_ahb_lite_fir_filter/DUT/FF/modwait
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/outreg_data
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/fir_out
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/fir_coefficient
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/D1/ext_data2
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -color Yellow -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/sample_data
add wave -noupdate -expand -group {FIR FILTER SIGNALS} -radix hexadecimal /tb_ahb_lite_fir_filter/DUT/FF/D1/ext_data1
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2875000 ps} 0}
...
update
WaveRestoreZoom {2720912 ps} {2988429 ps}
